...
export const siteConfig: PortfolioConfig = {
  ...
  banner: {
    imageSrc: "/banner.png",
    imageAlt: "Banner",
    openSourceUrl: "https://github.com/prateekjn/porto",
  ...
  about: {
    title: "About",
    body: "I’m a design engineer who blends product thinking, visual craft, and frontend systems. I enjoy turning rough ideas into interfaces that feel premium, perform well, and communicate value instantly. Most of my work is built in public through open-source projects where execution quality and iteration speed are visible.",
    emphasizedPhrases: ["design engineer", "open-source projects"],
  },
  services: {
